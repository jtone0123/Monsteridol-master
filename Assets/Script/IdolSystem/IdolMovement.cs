...
public class IdolMovement : MonoBehaviour
{
    ...
    private NavPoint currentTargetNavPointObject; // 현재 이동 목표 targetNavPoint 객체
    ...
    public void MoveTo(NavPoint targetNavPoint)
    {
        ...
        effector?.SetBool("isWalking", true);
    ...
    private void ArrivedAtTarget()
    {
        ...
        effector?.SetBool("isWalking", false);
    ...
    public void StopMovement()
    {
        ...
        effector?.SetBool("isWalking", false); // 애니메이션 상태 업데이트
        rb.linearVelocity = Vector2.zero;
